...
def main():
    ...
    # About info in sidebar
    st.sidebar.markdown("---")
    st.sidebar.title("About")
    st.sidebar.info(
        "This application uses YOLOv8 to detect PPE compliance. "
        "It can process images, videos, or webcam feed to check if "
        "required PPE items are properly worn."
    )
